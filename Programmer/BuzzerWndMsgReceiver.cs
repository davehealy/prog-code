...
{
	public class BuzzerWndMsgReceiver : Form
	{
		public delegate void OnRF215KeyPressedHandler(int nKeyPad, int key);

		public delegate void OnRF215QuizMasterRemotePressedHandler(QuizMasterRemoteCommands arg);
		...
		public event OnRF215KeyPressedHandler OnKeyPressed;

		public event OnRF215QuizMasterRemotePressedHandler OnQuizMasterRemotePressed;

		public event SetIDSucceededHandler OnSetIDSucceeded;

		public BuzzerWndMsgReceiver()
		{
			InitializeComponent();
		}

		private void BuzzerWndMsgReceiver_Load(object sender, EventArgs e)
		{
		...
		private void InitializeComponent()
		{
			...
			((Control)this).set_Name("BuzzerWndMsgReceiver");
			((Form)this).set_ShowInTaskbar(false);
			((Control)this).set_Text("BuzzerWndMsgReceiver");
			((Form)this).add_Load((EventHandler)BuzzerWndMsgReceiver_Load);
